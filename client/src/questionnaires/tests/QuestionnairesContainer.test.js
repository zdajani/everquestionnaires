...
describe('Questionnaires container', () => {
  ...
  describe('when questionnaires data is available', () => {
    ...
    it('renders self with questionnaires props', () => {    
      ...
      expect(connectedContainer.props().questionnaires).toEqual(questionnairesData);
    ...
    it('renders QuestionnairesList component', () => {   
      ...
      expect(container).toContainReact(<QuestionnairesList questionnaires={questionnairesData} />);
    });
  ...
  describe('when loading', () => {
    ...
    it('does not render QuestionnairesList component', () => {  
      expect(container).not.toContainReact(<QuestionnairesList questionnaires={questionnairesData} />);
    });
  });
});